...
#define PORT_AUTO_SELECT			INVALID_WORD				

#define DK_MAPPED					0x01												
...
#define SUB_KN_VALIDATE_SOCKET		2									

#define IPC_VER						1									
#define IPC_PACKET					(10240-sizeof(IPC_Head))			
#define IPC_BUFFER					(sizeof(IPC_Head)+IPC_PACKET)		
